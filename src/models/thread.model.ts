...
export class Thread implements ISubject {
  ...
  public addMessage(threadMessage: ThreadMessage) {
    ...
    const notificationMessage = `${threadMessage.createdBy.getFirstName() + threadMessage.createdBy.getLastName()} responded to your thread with: ${threadMessage.getMessage()}`;
