  ...
  createUser(
    ...
    switch (role) {
      case ScrumRole.PRODUCT_OWNER:
        return new ProductOwner(firstName, lastName, email, phoneNumber, role);
      case ScrumRole.SCRUM_MASTER:
        return new ScrumMaster(firstName, lastName, email, phoneNumber, role);
      case ScrumRole.DEVELOPER:
        return new Developer(firstName, lastName, email, phoneNumber, role);
      case ScrumRole.LEAD_DEVELOPER:
        return new LeadDeveloper(firstName, lastName, email, phoneNumber, role);
      case ScrumRole.TESTER:
        return new Tester(firstName, lastName, email, phoneNumber, role);
      default:
