...
import { ProductOwner, ScrumMaster, Developer, LeadDeveloper, Tester } from "../src/models/user.model";
  ...
  describe('createUser', () => {
    it('should create a ProductOwner instance', () => {
      const user = factory.createUser(
        ...
        '0637916452',
        [new NotificationPreference(NotificationType.EMAIL, 'erdemjoosten@gmail.com')],
    ...
    it('should create a Developer instance', () => {
      const user = factory.createUser(
        ...
        '0637916452',
        [new NotificationPreference(NotificationType.SLACK, 'erdemjoosten@gmail.com')],
        ScrumRole.DEVELOPER
      );
